...
function ACBDashboard() {
  ...
  const fetchCardData = async () => {
    try {
      const res = await axios.get(
        BASE_URL + "/API/Count/Dashboard/Details?report_id=2&year=2025"
      );
      if (res.status === 200) {
  ...
  const fetchOverdueData = async () => {
    try {
      const res = await axios.get(
        BASE_URL +
          "/API/List/Dashboard/Overdue/Report?page=0&size=1000&report_id=2&year=2025"
      );
      if (res.status === 200) {
  ...
  const fetchUpcomingData = async () => {
    try {
      const res = await axios.get(
        BASE_URL +
          "/API/List/Dashboard/Upcoming/Report?page=0&size=1000&report_id=2&year=2025"
      );
      if (res.status === 200) {
