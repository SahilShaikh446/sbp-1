...
export default function Report() {
  return (
    <div className="max-w-2xl mx-auto bg-white  font-sans text-sm border border-gray-300 shadow-lg">
      {/* Header */}
      <div className=" mb-4">
      ...
      <div className="max-w-[75%] mx-auto">
        ...
        <div className="flex justify-between items-center">
          <div>
            <p>
              <strong>Report No.: 01/25-26</strong>
            </p>
          </div>
          <div>
            <p>
          ...
          <table className="w-full text-xs border-separate border-spacing-y-2">
            <tbody className="font-semibold">
              ...
              <tr className="">
                ...
                <td className="">
                  {" "}
                  <div className="w-12 inline-block">:</div>41083/1 Year - 2011
                </td>
              </tr>
              <tr className="">
              ...
              <tr className="">
                ...
                <td className="">
                  {" "}
                  <div className="w-12 inline-block">:</div>Sample withdrawn at
                  80 KV for 1 minute
                </td>
              </tr>
              <tr className="">
                ...
                <td className="align-top">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="max-w-prose">
                      ...
                      oil gauge, temp. Total Gasket and Total Gasket Not Boil is
                      replaced. O.L.T.C. oil new. Filled up and painting Epoxy.
                    </div>
                  </div>
                </td>
              </tr>
